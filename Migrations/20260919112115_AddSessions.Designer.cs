...
namespace MediaArchive.Migrations
{
    ...
    [Migration("20260919112115_AddSessions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaArchive.Models.ConsumptionEntry", b =>
                {
                    ...
                    b.Property<int?>("ResumesEntryId")
                        .HasColumnType("INTEGER");

                    b.Property<DateOnly?>("StartDate")
                        .HasColumnType("TEXT");

                    b.Property<int?>("StartingEffort")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaArchive.Models.MediaItemCredit", b =>
                {
            ...
            modelBuilder.Entity("MediaArchive.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaArchive.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaArchive.Models.ConsumptionEntry", b =>
                {
                    b.HasOne("MediaArchive.Models.ConsumptionEntry", "ResumesEntry")
                        .WithMany()
                        .HasForeignKey("ResumesEntryId")
            ...
            modelBuilder.Entity("MediaArchive.Models.MediaItemCredit", b =>
                {
                    ...
                    b.HasOne("MediaArchive.Models.Person", "Person")
                        .WithMany("Credits")
            ...
            modelBuilder.Entity("MediaArchive.Models.Session", b =>
                {
                    ...
                    b.HasOne("MediaArchive.Models.EntryNote", "EntryNote")
                        .WithMany()
                        .HasForeignKey("EntryNoteId")
                        .OnDelete(DeleteBehavior.SetNull);
